...
import { getDepartmentDetailsById } from "../../../utils/queries/employee-queries";
...
export default async function DepartmentProfilePage({ params }: Props) {
  ...
  if (!dept) redirect("/hris/departments");
  ...
  return (
    <div className="max-w-4xl mx-auto mt-8">
      <ProfileViewer
        title={dept.name}
        subtitle="Department profile unit"
        initials={initials}
        statusBadge={
