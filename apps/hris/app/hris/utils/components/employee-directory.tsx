    ...
    <div className="mt-8">
      ...
      <div className="flex border-b border-border/60 mb-6">
        <button
          ...
          className={`px-4 py-2 font-display text-sm font-semibold border-b-2 transition-colors ${activeTab === "dashboard"
        ...
        <button
          ...
          className={`px-4 py-2 font-display text-sm font-semibold border-b-2 transition-colors ${activeTab === "employees"
              ? "border-primary text-primary"
              : "border-transparent text-muted-foreground hover:text-foreground"
            }`}
        >
