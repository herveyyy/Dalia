...
import { getBranchDetailsById } from "../../../../../../hris/app/hris/utils/queries/employee-queries";
...
export default async function WorkspaceBranchProfilePage({ params }: Props) {
  ...
  if (!br) redirect("/workspace/branches");
